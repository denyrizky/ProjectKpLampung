...
class MenengahIlmeaController extends Controller
{
    public $user;
    ...
    public function index()
    {
        ...
        $data = ILMEAMENGAH::all();
        return view('backend.pages.menengahIlmea.index', compact('data'));
    }

    public function store(Request $request)
    {
        // Process Data
        $data = ILMEAMENGAH::create([
        ...
        session()->flash('success', 'Data Industri Menengah Bidang ILMEA Berhasil Dibuat !!');
        return redirect('admin/menengahIlmea');
    }

    public function update(Request $request, $id)
    {

        $data = ILMEAMENGAH::findOrFail($id);
        ...
        $data->save();
        session()->flash('success', 'Data Industri Menengah Bidang ILMEA Berhasil Diubah !!');
    ...
    {
        ILMEAMENGAH::findOrFail($id)->delete();
        session()->flash('error', 'Data Industri Menengah Bidang ILMEA Berhasil Dihapus !!');
